;;; Moodier-Line-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...

;;; Generated autoloads from moodier-line.el
...
either customize it (see the info node `Easy Customization')
or call the function `mood-line-mode'.")
(custom-autoload 'mood-line-mode "moodier-line" nil)
(autoload 'mood-line-mode "moodier-line" "\
Toggle mood-line on or off.
...
(fn &optional ARG)" t)
(register-definition-prefixes "moodier-line" '("mood-line-"))


;;; End of scraped data

(provide 'Moodier-Line-autoloads)
...
;;; Moodier-Line-autoloads.el ends here
